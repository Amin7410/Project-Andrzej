...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: II.27.16                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for II.27.16: epsilon*c*Ef**2")
            ...
            plt.title(f"Parity Plot for II.27.16: epsilon*c*Ef**2")
            plt.xlabel('Actual y')

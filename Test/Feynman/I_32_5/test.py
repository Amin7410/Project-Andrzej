...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: I.32.5                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for I.32.5: q**2*a**2/(6*pi*epsilon*c**3)")
            ...
            plt.title(f"Parity Plot for I.32.5: q**2*a**2/(6*pi*epsilon*c**3)")
            plt.xlabel('Actual y')

...
EQ_DATA = {
    ...
    "n_vars": 3,
    "var_names": ['c', 'v', 'omega_0'],
    "var_ranges": [(3.0, 10.0), (1.0, 2.0), (1.0, 5.0)]
}
...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: I.34.1                ")
    print("===========================================================")
    ...
    searcher = SmartSearcher(max_complexity=8, beam_width=1000)
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for I.34.1: omega_0/(1-v/c)")
            ...
            plt.title(f"Parity Plot for I.34.1: omega_0/(1-v/c)")
            plt.xlabel('Actual y')

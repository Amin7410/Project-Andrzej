...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: I.6.2a                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for I.6.2a: exp(-theta**2/2)/sqrt(2*pi)")
            ...
            plt.title(f"Parity Plot for I.6.2a: exp(-theta**2/2)/sqrt(2*pi)")
            plt.xlabel('Actual y')

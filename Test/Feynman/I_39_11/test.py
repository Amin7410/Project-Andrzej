...
EQ_DATA = {
    ...
    "n_vars": 3,
    "var_names": ['gamma', 'pr', 'V'],
    "var_ranges": [(2.0, 5.0), (1.0, 5.0), (1.0, 5.0)]
}
...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: I.39.11                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for I.39.11: 1/(gamma-1)*pr*V")
            ...
            plt.title(f"Parity Plot for I.39.11: 1/(gamma-1)*pr*V")
            plt.xlabel('Actual y')

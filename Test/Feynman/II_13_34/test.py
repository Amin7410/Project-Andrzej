...
EQ_DATA = {
    ...
    "n_vars": 3,
    "var_names": ['rho_c_0', 'v', 'c'],
    "var_ranges": [(1.0, 5.0), (1.0, 2.0), (3.0, 10.0)]
}
...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: II.13.34                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for II.13.34: rho_c_0*v/sqrt(1-v**2/c**2)")
            ...
            plt.title(f"Parity Plot for II.13.34: rho_c_0*v/sqrt(1-v**2/c**2)")
            plt.xlabel('Actual y')

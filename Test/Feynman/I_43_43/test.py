...
EQ_DATA = {
    ...
    "n_vars": 4,
    "var_names": ['gamma', 'kb', 'A', 'v'],
    "var_ranges": [(2.0, 5.0), (1.0, 5.0), (1.0, 5.0), (1.0, 5.0)]
}
...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: I.43.43                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for I.43.43: 1/(gamma-1)*kb*v/A")
            ...
            plt.title(f"Parity Plot for I.43.43: 1/(gamma-1)*kb*v/A")
            plt.xlabel('Actual y')

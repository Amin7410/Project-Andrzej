...
EQ_DATA = {
    ...
    "n_vars": 3,
    "var_names": ['lambd', 'd', 'n'],
    "var_ranges": [(1.0, 2.0), (2.0, 5.0), (1.0, 5.0)]
}
...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: I.30.5                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for I.30.5: arcsin(lambd/(n*d))")
            ...
            plt.title(f"Parity Plot for I.30.5: arcsin(lambd/(n*d))")
            plt.xlabel('Actual y')

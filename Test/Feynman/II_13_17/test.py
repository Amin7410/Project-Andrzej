...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: II.13.17                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for II.13.17: 1/(4*pi*epsilon*c**2)*2*I/r")
            ...
            plt.title(f"Parity Plot for II.13.17: 1/(4*pi*epsilon*c**2)*2*I/r")
            plt.xlabel('Actual y')

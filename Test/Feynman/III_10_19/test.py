...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: III.10.19                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for III.10.19: mom*sqrt(Bx**2+By**2+Bz**2)")
            ...
            plt.title(f"Parity Plot for III.10.19: mom*sqrt(Bx**2+By**2+Bz**2)")
            plt.xlabel('Actual y')

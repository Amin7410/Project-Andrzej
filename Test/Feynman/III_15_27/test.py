...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: III.15.27                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for III.15.27: 2*pi*alpha/(n*d)")
            ...
            plt.title(f"Parity Plot for III.15.27: 2*pi*alpha/(n*d)")
            plt.xlabel('Actual y')

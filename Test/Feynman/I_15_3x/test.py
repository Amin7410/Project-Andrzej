...
EQ_DATA = {
    ...
    "n_vars": 4,
    "var_names": ['x', 'u', 'c', 't'],
    "var_ranges": [(-10.0, 10.0), (1.0, 2.0), (3.0, 20.0), (1.0, 2.0)]
}
...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: I.15.3x                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for I.15.3x: (x-u*t)/sqrt(1-u**2/c**2)")
            ...
            plt.title(f"Parity Plot for I.15.3x: (x-u*t)/sqrt(1-u**2/c**2)")
            plt.xlabel('Actual y')

...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: I.43.16                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for I.43.16: mu_drift*q*Volt/d")
            ...
            plt.title(f"Parity Plot for I.43.16: mu_drift*q*Volt/d")
            plt.xlabel('Actual y')

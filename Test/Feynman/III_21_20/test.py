...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: III.21.20                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for III.21.20: -rho_c_0*q*A_vec/m")
            ...
            plt.title(f"Parity Plot for III.21.20: -rho_c_0*q*A_vec/m")
            plt.xlabel('Actual y')

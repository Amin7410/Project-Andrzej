...
EQ_DATA = {
    ...
    "n_vars": 5,
    "var_names": ['q', 'Ef', 'B', 'v', 'theta'],
    "var_ranges": [(1.0, 5.0), (1.0, 5.0), (1.0, 5.0), (1.0, 5.0), (-5.0, 5.0)]
}
...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: I.12.11                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for I.12.11: q*(Ef+B*v*sin(theta))")
            ...
            plt.title(f"Parity Plot for I.12.11: q*(Ef+B*v*sin(theta))")
            plt.xlabel('Actual y')

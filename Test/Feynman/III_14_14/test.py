...
EQ_DATA = {
    ...
    "n_vars": 5,
    "var_names": ['I_0', 'q', 'Volt', 'kb', 'T'],
    "var_ranges": [(1.0, 5.0), (1.0, 2.0), (1.0, 2.0), (1.0, 2.0), (1.0, 2.0)]
}
...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: III.14.14                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for III.14.14: I_0*(exp(q*Volt/(kb*T))-1)")
            ...
            plt.title(f"Parity Plot for III.14.14: I_0*(exp(q*Volt/(kb*T))-1)")
            plt.xlabel('Actual y')

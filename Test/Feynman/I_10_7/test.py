...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: I.10.7                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for I.10.7: m_0/sqrt(1-v**2/c**2)")
            ...
            plt.title(f"Parity Plot for I.10.7: m_0/sqrt(1-v**2/c**2)")
            plt.xlabel('Actual y')

...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: II.27.18                ")
    print("===========================================================")
    ...
    print(f"\n[EML-SR] Initializing Searcher (max_complexity=7, beam_width=500)...")
    searcher = SmartSearcher(max_complexity=7, beam_width=500)
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for II.27.18: epsilon*Ef**2")
            ...
            plt.title(f"Parity Plot for II.27.18: epsilon*Ef**2")
            plt.xlabel('Actual y')

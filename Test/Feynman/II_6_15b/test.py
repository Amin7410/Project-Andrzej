...
EQ_DATA = {
    ...
    "n_vars": 4,
    "var_names": ['epsilon', 'p_d', 'theta', 'r'],
    "var_ranges": [(1.0, 3.0), (1.0, 3.0), (-3.0, 3.0), (1.0, 3.0)]
}
...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: II.6.15b                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for II.6.15b: p_d/(4*pi*epsilon)*3*cos(theta)*sin(theta)/r**3")
            ...
            plt.title(f"Parity Plot for II.6.15b: p_d/(4*pi*epsilon)*3*cos(theta)*sin(theta)/r**3")
            plt.xlabel('Actual y')

...
EQ_DATA = {
    ...
    "n_vars": 3,
    "var_names": ['r', 'F', 'theta'],
    "var_ranges": [(1.0, 5.0), (1.0, 5.0), (-5.0, 5.0)]
}
...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: I.18.12                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for I.18.12: r*F*sin(theta)")
            ...
            plt.title(f"Parity Plot for I.18.12: r*F*sin(theta)")
            plt.xlabel('Actual y')

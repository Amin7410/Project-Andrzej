...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: II.8.7                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for II.8.7: 3/5*q**2/(4*pi*epsilon*d)")
            ...
            plt.title(f"Parity Plot for II.8.7: 3/5*q**2/(4*pi*epsilon*d)")
            plt.xlabel('Actual y')

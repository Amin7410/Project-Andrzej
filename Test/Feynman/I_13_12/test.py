...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: I.13.12                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for I.13.12: G*m1*m2*(1/r2-1/r1)")
            ...
            plt.title(f"Parity Plot for I.13.12: G*m1*m2*(1/r2-1/r1)")
            plt.xlabel('Actual y')

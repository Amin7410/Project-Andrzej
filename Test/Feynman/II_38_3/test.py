...
EQ_DATA = {
    ...
    "n_vars": 4,
    "var_names": ['Y', 'A', 'd', 'x'],
    "var_ranges": [(1.0, 5.0), (1.0, 5.0), (1.0, 5.0), (-5.0, 5.0)]
}
...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: II.38.3                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for II.38.3: Y*A*x/d")
            ...
            plt.title(f"Parity Plot for II.38.3: Y*A*x/d")
            plt.xlabel('Actual y')

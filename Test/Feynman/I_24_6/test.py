...
EQ_DATA = {
    ...
    "var_ranges": [(1.0, 3.0), (1.0, 3.0), (1.0, 3.0), (-3.0, 3.0)]
}
...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: I.24.6                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for I.24.6: 1/2*m*(omega**2+omega_0**2)*1/2*x**2")
            ...
            plt.title(f"Parity Plot for I.24.6: 1/2*m*(omega**2+omega_0**2)*1/2*x**2")
            plt.xlabel('Actual y')

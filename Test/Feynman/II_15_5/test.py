...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: II.15.5                ")
    print("===========================================================")
    ...
    searcher = SmartSearcher(max_complexity=8, beam_width=500)
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for II.15.5: -p_d*Ef*cos(theta)")
            ...
            plt.title(f"Parity Plot for II.15.5: -p_d*Ef*cos(theta)")
            plt.xlabel('Actual y')

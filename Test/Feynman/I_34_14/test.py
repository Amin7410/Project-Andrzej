...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: I.34.14                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for I.34.14: (1+v/c)/sqrt(1-v**2/c**2)*omega_0")
            ...
            plt.title(f"Parity Plot for I.34.14: (1+v/c)/sqrt(1-v**2/c**2)*omega_0")
            plt.xlabel('Actual y')

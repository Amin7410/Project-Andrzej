...
EQ_DATA = {
    ...
    "var_ranges": [(-5.0, 5.0), (-5.0, 5.0), (1.0, 5.0), (-5.0, 5.0), (-5.0, 5.0), (1.0, 5.0)]
}
...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: I.11.19                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for I.11.19: x1*y1+x2*y2+x3*y3")
            ...
            plt.title(f"Parity Plot for I.11.19: x1*y1+x2*y2+x3*y3")
            plt.xlabel('Actual y')

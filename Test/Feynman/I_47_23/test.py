...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: I.47.23                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for I.47.23: sqrt(gamma*pr/rho)")
            ...
            plt.title(f"Parity Plot for I.47.23: sqrt(gamma*pr/rho)")
            plt.xlabel('Actual y')

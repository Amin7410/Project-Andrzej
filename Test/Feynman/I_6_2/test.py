...
EQ_DATA = {
    ...
    "n_vars": 2,
    "var_names": ['sigma', 'theta'],
    "var_ranges": [(1.0, 3.0), (-3.0, 3.0)]
}
...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: I.6.2                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for I.6.2: exp(-(theta/sigma)**2/2)/(sqrt(2*pi)*sigma)")
            ...
            plt.title(f"Parity Plot for I.6.2: exp(-(theta/sigma)**2/2)/(sqrt(2*pi)*sigma)")
            plt.xlabel('Actual y')

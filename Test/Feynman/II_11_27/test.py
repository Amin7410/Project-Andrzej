...
EQ_DATA = {
    ...
    "n_vars": 4,
    "var_names": ['n', 'alpha', 'epsilon', 'Ef'],
    "var_ranges": [(0.0, 1.0), (0.0, 1.0), (1.0, 2.0), (1.0, 2.0)]
}
...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: II.11.27                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for II.11.27: n*alpha/(1-(n*alpha/3))*epsilon*Ef")
            ...
            plt.title(f"Parity Plot for II.11.27: n*alpha/(1-(n*alpha/3))*epsilon*Ef")
            plt.xlabel('Actual y')

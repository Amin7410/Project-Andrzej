...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: I.38.12                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for I.38.12: 4*pi*epsilon*(h/(2*pi))**2/(m*q**2)")
            ...
            plt.title(f"Parity Plot for I.38.12: 4*pi*epsilon*(h/(2*pi))**2/(m*q**2)")
            plt.xlabel('Actual y')

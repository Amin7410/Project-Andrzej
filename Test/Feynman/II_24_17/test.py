...
EQ_DATA = {
    ...
    "n_vars": 3,
    "var_names": ['omega', 'c', 'd'],
    "var_ranges": [(4.0, 6.0), (1.0, 2.0), (2.0, 4.0)]
}
...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: II.24.17                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for II.24.17: sqrt(omega**2/c**2-pi**2/d**2)")
            ...
            plt.title(f"Parity Plot for II.24.17: sqrt(omega**2/c**2-pi**2/d**2)")
            plt.xlabel('Actual y')

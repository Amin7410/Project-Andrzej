...
EQ_DATA = {
    ...
    "n_vars": 5,
    "var_names": ['q', 'Ef', 'm', 'omega_0', 'omega'],
    "var_ranges": [(1.0, 3.0), (1.0, 3.0), (1.0, 3.0), (3.0, 5.0), (1.0, 2.0)]
}
...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: II.11.3                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for II.11.3: q*Ef/(m*(omega_0**2-omega**2))")
            ...
            plt.title(f"Parity Plot for II.11.3: q*Ef/(m*(omega_0**2-omega**2))")
            plt.xlabel('Actual y')

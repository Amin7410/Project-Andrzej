...
EQ_DATA = {
    ...
    "n_vars": 3,
    "var_names": ['E_n', 't', 'h'],
    "var_ranges": [(1.0, 2.0), (1.0, 2.0), (1.0, 4.0)]
}
...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: III.8.54                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for III.8.54: sin(E_n*t/(h/(2*pi)))**2")
            ...
            plt.title(f"Parity Plot for III.8.54: sin(E_n*t/(h/(2*pi)))**2")
            plt.xlabel('Actual y')

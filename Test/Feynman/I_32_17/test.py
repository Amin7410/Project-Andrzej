...
EQ_DATA = {
    ...
    "n_vars": 6,
    "var_names": ['epsilon', 'c', 'Ef', 'r', 'omega', 'omega_0'],
    "var_ranges": [(1.0, 2.0), (1.0, 2.0), (1.0, 2.0), (1.0, 2.0), (1.0, 2.0), (3.0, 5.0)]
}
...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: I.32.17                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for I.32.17: (1/2*epsilon*c*Ef**2)*(8*pi*r**2/3)*(omega**4/(omega**2-omega_0**2)**2)")
            ...
            plt.title(f"Parity Plot for I.32.17: (1/2*epsilon*c*Ef**2)*(8*pi*r**2/3)*(omega**4/(omega**2-omega_0**2)**2)")
            plt.xlabel('Actual y')

...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: I.18.4                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for I.18.4: (m1*r1+m2*r2)/(m1+m2)")
            ...
            plt.title(f"Parity Plot for I.18.4: (m1*r1+m2*r2)/(m1+m2)")
            plt.xlabel('Actual y')

...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: II.11.28                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for II.11.28: 1+n*alpha/(1-(n*alpha/3))")
            ...
            plt.title(f"Parity Plot for II.11.28: 1+n*alpha/(1-(n*alpha/3))")
            plt.xlabel('Actual y')

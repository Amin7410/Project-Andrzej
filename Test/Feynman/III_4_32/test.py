...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: III.4.32                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for III.4.32: 1/(exp((h/(2*pi))*omega/(kb*T))-1)")
            ...
            plt.title(f"Parity Plot for III.4.32: 1/(exp((h/(2*pi))*omega/(kb*T))-1)")
            plt.xlabel('Actual y')

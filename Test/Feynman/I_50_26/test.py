...
EQ_DATA = {
    ...
    "n_vars": 4,
    "var_names": ['x1', 'omega', 't', 'alpha'],
    "var_ranges": [(-3.0, 3.0), (1.0, 3.0), (1.0, 3.0), (1.0, 3.0)]
}
...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: I.50.26                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for I.50.26: x1*(cos(omega*t)+alpha*cos(omega*t)**2)")
            ...
            plt.title(f"Parity Plot for I.50.26: x1*(cos(omega*t)+alpha*cos(omega*t)**2)")
            plt.xlabel('Actual y')

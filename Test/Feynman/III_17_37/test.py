...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: III.17.37                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for III.17.37: beta*(1+alpha*cos(theta))")
            ...
            plt.title(f"Parity Plot for III.17.37: beta*(1+alpha*cos(theta))")
            plt.xlabel('Actual y')

...
EQ_DATA = {
    ...
    "n_vars": 8,
    "var_names": ['mom', 'H', 'kb', 'T', 'alpha', 'epsilon', 'c', 'M'],
    "var_ranges": [(1.0, 3.0), (1.0, 3.0), (1.0, 3.0), (1.0, 3.0), (1.0, 3.0), (1.0, 3.0), (1.0, 3.0), (1.0, 3.0)]
}
...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: II.36.38                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for II.36.38: mom*H/(kb*T)+(mom*alpha)/(epsilon*c**2*kb*T)*M")
            ...
            plt.title(f"Parity Plot for II.36.38: mom*H/(kb*T)+(mom*alpha)/(epsilon*c**2*kb*T)*M")
            plt.xlabel('Actual y')

...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: III.13.18                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for III.13.18: 2*E_n*d**2*k/(h/(2*pi))")
            ...
            plt.title(f"Parity Plot for III.13.18: 2*E_n*d**2*k/(h/(2*pi))")
            plt.xlabel('Actual y')

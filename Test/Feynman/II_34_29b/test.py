...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: II.34.29b                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for II.34.29b: g_*mom*B*Jz/(h/(2*pi))")
            ...
            plt.title(f"Parity Plot for II.34.29b: g_*mom*B*Jz/(h/(2*pi))")
            plt.xlabel('Actual y')

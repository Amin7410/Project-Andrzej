...
EQ_DATA = {
    ...
    "n_vars": 6,
    "var_names": ['epsilon', 'p_d', 'r', 'x', 'y', 'z'],
    "var_ranges": [(1.0, 3.0), (1.0, 3.0), (1.0, 3.0), (-3.0, 3.0), (-3.0, 3.0), (-3.0, 3.0)]
}
...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: II.6.15a                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for II.6.15a: p_d/(4*pi*epsilon)*3*z/r**5*sqrt(x**2+y**2)")
            ...
            plt.title(f"Parity Plot for II.6.15a: p_d/(4*pi*epsilon)*3*z/r**5*sqrt(x**2+y**2)")
            plt.xlabel('Actual y')

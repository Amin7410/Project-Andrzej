...
EQ_DATA = {
    ...
    "n_vars": 3,
    "var_names": ['sigma_den', 'epsilon', 'chi'],
...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: II.10.9                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for II.10.9: sigma_den/epsilon*1/(1+chi)")
            ...
            plt.title(f"Parity Plot for II.10.9: sigma_den/epsilon*1/(1+chi)")
            plt.xlabel('Actual y')

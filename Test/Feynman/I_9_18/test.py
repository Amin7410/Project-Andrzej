...
EQ_DATA = {
    ...
    "n_vars": 9,
    "var_names": ['m1', 'm2', 'G', 'x1', 'x2', 'y1', 'y2', 'z1', 'z2'],
    "var_ranges": [(1.0, 2.0), (1.0, 2.0), (1.0, 2.0), (-4.0, 4.0), (-2.0, 2.0), (-4.0, 4.0), (-2.0, 2.0), (-4.0, 4.0), (-2.0, 2.0)]
}
...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: I.9.18                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for I.9.18: G*m1*m2/((x2-x1)**2+(y2-y1)**2+(z2-z1)**2)")
            ...
            plt.title(f"Parity Plot for I.9.18: G*m1*m2/((x2-x1)**2+(y2-y1)**2+(z2-z1)**2)")
            plt.xlabel('Actual y')

...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: II.15.4                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for II.15.4: -mom*B*cos(theta)")
            ...
            plt.title(f"Parity Plot for II.15.4: -mom*B*cos(theta)")
            plt.xlabel('Actual y')

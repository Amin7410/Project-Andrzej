...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: I.44.4                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for I.44.4: n*kb*T*ln(V2/V1)")
            ...
            plt.title(f"Parity Plot for I.44.4: n*kb*T*ln(V2/V1)")
            plt.xlabel('Actual y')

...
EQ_DATA = {
    ...
    "n_vars": 5,
    "var_names": ['omega', 'T', 'h', 'kb', 'c'],
    "var_ranges": [(1.0, 5.0), (1.0, 5.0), (1.0, 5.0), (1.0, 5.0), (1.0, 5.0)]
}
...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: I.41.16                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for I.41.16: h/(2*pi)*omega**3/(pi**2*c**2*(exp((h/(2*pi))*omega/(kb*T))-1))")
            ...
            plt.title(f"Parity Plot for I.41.16: h/(2*pi)*omega**3/(pi**2*c**2*(exp((h/(2*pi))*omega/(kb*T))-1))")
            plt.xlabel('Actual y')

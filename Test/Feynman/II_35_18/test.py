...
EQ_DATA = {
    ...
    "n_vars": 5,
    "var_names": ['n_0', 'kb', 'T', 'mom', 'B'],
    "var_ranges": [(1.0, 3.0), (1.0, 3.0), (1.0, 3.0), (1.0, 3.0), (1.0, 3.0)]
}
...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: II.35.18                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for II.35.18: n_0/(exp(mom*B/(kb*T))+exp(-mom*B/(kb*T)))")
            ...
            plt.title(f"Parity Plot for II.35.18: n_0/(exp(mom*B/(kb*T))+exp(-mom*B/(kb*T)))")
            plt.xlabel('Actual y')

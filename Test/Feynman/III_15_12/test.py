...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: III.15.12                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for III.15.12: 2*U*(1-cos(k*d))")
            ...
            plt.title(f"Parity Plot for III.15.12: 2*U*(1-cos(k*d))")
            plt.xlabel('Actual y')

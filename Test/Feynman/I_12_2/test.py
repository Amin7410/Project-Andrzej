...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: I.12.2                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for I.12.2: q1*q2*r/(4*pi*epsilon*r**3)")
            ...
            plt.title(f"Parity Plot for I.12.2: q1*q2*r/(4*pi*epsilon*r**3)")
            plt.xlabel('Actual y')

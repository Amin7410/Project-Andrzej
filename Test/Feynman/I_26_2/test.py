...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: I.26.2                ")
    print("===========================================================")
    ...
    print(f"\n[EML-SR] Initializing Searcher (max_complexity=6, beam_width=200)...")
    searcher = SmartSearcher(max_complexity=6, beam_width=200)
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for I.26.2: arcsin(n*sin(theta2))")
            ...
            plt.title(f"Parity Plot for I.26.2: arcsin(n*sin(theta2))")
            plt.xlabel('Actual y')

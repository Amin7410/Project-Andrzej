...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: III.15.14                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for III.15.14: (h/(2*pi))**2/(2*E_n*d**2)")
            ...
            plt.title(f"Parity Plot for III.15.14: (h/(2*pi))**2/(2*E_n*d**2)")
            plt.xlabel('Actual y')

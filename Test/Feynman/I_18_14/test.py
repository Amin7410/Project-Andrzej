...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: I.18.14                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for I.18.14: m*r*v*sin(theta)")
            ...
            plt.title(f"Parity Plot for I.18.14: m*r*v*sin(theta)")
            plt.xlabel('Actual y')

...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: II.11.20                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for II.11.20: n_rho*p_d**2*Ef/(3*kb*T)")
            ...
            plt.title(f"Parity Plot for II.11.20: n_rho*p_d**2*Ef/(3*kb*T)")
            plt.xlabel('Actual y')

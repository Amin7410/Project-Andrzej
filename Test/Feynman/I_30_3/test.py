...
EQ_DATA = {
    ...
    "n_vars": 3,
    "var_names": ['Int_0', 'theta', 'n'],
    "var_ranges": [(1.0, 5.0), (-5.0, 5.0), (1.0, 5.0)]
}
...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: I.30.3                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for I.30.3: Int_0*sin(n*theta/2)**2/sin(theta/2)**2")
            ...
            plt.title(f"Parity Plot for I.30.3: Int_0*sin(n*theta/2)**2/sin(theta/2)**2")
            plt.xlabel('Actual y')

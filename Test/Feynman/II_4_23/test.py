...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: II.4.23                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for II.4.23: q/(4*pi*epsilon*r)")
            ...
            plt.title(f"Parity Plot for II.4.23: q/(4*pi*epsilon*r)")
            plt.xlabel('Actual y')

...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: II.6.11                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for II.6.11: 1/(4*pi*epsilon)*p_d*cos(theta)/r**2")
            ...
            plt.title(f"Parity Plot for II.6.11: 1/(4*pi*epsilon)*p_d*cos(theta)/r**2")
            plt.xlabel('Actual y')

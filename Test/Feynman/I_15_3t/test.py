...
EQ_DATA = {
    ...
    "n_vars": 4,
    "var_names": ['x', 'c', 'u', 't'],
    "var_ranges": [(-5.0, 5.0), (3.0, 10.0), (1.0, 2.0), (1.0, 5.0)]
}
...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: I.15.3t                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for I.15.3t: (t-u*x/c**2)/sqrt(1-u**2/c**2)")
            ...
            plt.title(f"Parity Plot for I.15.3t: (t-u*x/c**2)/sqrt(1-u**2/c**2)")
            plt.xlabel('Actual y')

...
EQ_DATA = {
    ...
    "n_vars": 6,
    "var_names": ['n_0', 'm', 'x', 'T', 'g', 'kb'],
    "var_ranges": [(1.0, 5.0), (1.0, 5.0), (-5.0, 5.0), (1.0, 5.0), (1.0, 5.0), (1.0, 5.0)]
}
...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: I.40.1                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for I.40.1: n_0*exp(-m*g*x/(kb*T))")
            ...
            plt.title(f"Parity Plot for I.40.1: n_0*exp(-m*g*x/(kb*T))")
            plt.xlabel('Actual y')

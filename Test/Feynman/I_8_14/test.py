...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: I.8.14                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for I.8.14: sqrt((x2-x1)**2+(y2-y1)**2)")
            ...
            plt.title(f"Parity Plot for I.8.14: sqrt((x2-x1)**2+(y2-y1)**2)")
            plt.xlabel('Actual y')

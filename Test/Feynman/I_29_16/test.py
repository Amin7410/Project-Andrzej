...
EQ_DATA = {
    ...
    "n_vars": 4,
    "var_names": ['x1', 'x2', 'theta1', 'theta2'],
    "var_ranges": [(-5.0, 5.0), (-5.0, 5.0), (-5.0, 5.0), (-5.0, 5.0)]
}
...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: I.29.16                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for I.29.16: sqrt(x1**2+x2**2-2*x1*x2*cos(theta1-theta2))")
            ...
            plt.title(f"Parity Plot for I.29.16: sqrt(x1**2+x2**2-2*x1*x2*cos(theta1-theta2))")
            plt.xlabel('Actual y')

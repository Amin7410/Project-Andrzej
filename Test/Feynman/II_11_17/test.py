...
EQ_DATA = {
    ...
    "n_vars": 6,
    "var_names": ['n_0', 'kb', 'T', 'theta', 'p_d', 'Ef'],
    "var_ranges": [(1.0, 3.0), (1.0, 3.0), (1.0, 3.0), (-3.0, 3.0), (1.0, 3.0), (1.0, 3.0)]
}
...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: II.11.17                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for II.11.17: n_0*(1+p_d*Ef*cos(theta)/(kb*T))")
            ...
            plt.title(f"Parity Plot for II.11.17: n_0*(1+p_d*Ef*cos(theta)/(kb*T))")
            plt.xlabel('Actual y')

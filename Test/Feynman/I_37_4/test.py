...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: I.37.4                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for I.37.4: I1+I2+2*sqrt(I1*I2)*cos(delta)")
            ...
            plt.title(f"Parity Plot for I.37.4: I1+I2+2*sqrt(I1*I2)*cos(delta)")
            plt.xlabel('Actual y')

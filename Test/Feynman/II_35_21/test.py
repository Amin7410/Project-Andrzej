...
def main():
    ...
    print("===========================================================")
    print(f"      EML-SR RUNNING FEYNMAN EQUATION: II.35.21                ")
    print("===========================================================")
    ...
    try:
        ...
        if eq['n_vars'] == 1:
            ...
            plt.title(f"EML-SR Fit for II.35.21: n_rho*mom*tanh(mom*B/(kb*T))")
            ...
            plt.title(f"Parity Plot for II.35.21: n_rho*mom*tanh(mom*B/(kb*T))")
            plt.xlabel('Actual y')
